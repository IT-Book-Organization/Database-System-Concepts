...
만약 **α ⊆ R이고 β ⊆ R인 α → β 형태의 F+의 모든 함수 종속**이 다음 중 적어도 하나라도 만족한다면, 함수 종속의 집합 F와 관련하여 릴레이션 스키마 R는 BCNF에 있다.
...
R가 BCNF가 아닌 스키마이며  
자명하지 않은 함수 종속 α → β가 최소 한 개 존재하고, α는 R에 대한 수퍼 키가 아니라고 하자.
...
<p align="center"><img width="580" alt="dept_advisor" src="https://user-images.githubusercontent.com/86337233/226106157-9d36d8bf-76ed-4739-a4a2-1f904b2209ae.png">
...
그럼에도 불구하고, 3NF는 데이터 항목 간의 생길 수 있는 몇몇 의미적인 연관성을 표현하기 위해 **null 값**을 사용해야 할 수도 있으며, **정보 반복 문제**도 가지고 있다.
